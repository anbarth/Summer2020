...
To make a heatmap, first run heatmapCsvMaker. This script does all the number crunching and creates a csv with all the numbers for a heatmap. For a sense of the run time: when nMax=10, dx=0.05, bounds are [-20,20], and numRegressions=100, that takes ~20 minutes to run on Erwin.
...
- wavefunctionDisplay:  plot 1 or 2 energy eigenfunction
